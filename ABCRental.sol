...
contract ABCRental {
   ...
   function rentCar(uint _carId, uint _noOfDays) payable
       public checkCarAvailability(_carId) {
       require(msg.value == (_noOfDays * carCatalogue[_carId]._costPerDay), "INCORRECT PAYMENT!");
